...
namespace Infosalons.Application.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            var isExist = await _unitOfWork.Users.CheckIsRegistered(user.Email);
        ...
        {
            var isExist = await _unitOfWork.Users.CheckIsRegistered(cred.Email);
            ...
            {
                return BadRequest("Email address not registered");
            }
        }
